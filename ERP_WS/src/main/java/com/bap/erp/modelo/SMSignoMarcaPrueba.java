...
@Entity
@Table(name = "SMSignoMarcaPrueba")
public class SMSignoMarcaPrueba extends AbstractEntity implements Serializable {
    ...
    @Column(name = "TipoSolicitudSigno")
    private String tipoSolicitudSigno;
