USE [master]
GO
/****** Object:  Database [cpanel]    Script Date: 06/16/2015 16:55:11 ******/
...
( NAME = N'cpanel', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLEXPRESS\MSSQL\DATA\cpanel.mdf' , SIZE = 2304KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'cpanel_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLEXPRESS\MSSQL\DATA\cpanel_1.LDF' , SIZE = 832KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
...
GO
ALTER DATABASE [cpanel] SET  DISABLE_BROKER
GO
...
USE [cpanel]
GO
/****** Object:  Table [dbo].[ADM_MODULO]    Script Date: 06/16/2015 16:55:14 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[CLI_EMPRESA]    Script Date: 06/16/2015 16:55:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[ADM_ROL]    Script Date: 06/16/2015 16:55:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[ADM_PERSONA]    Script Date: 06/16/2015 16:55:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[PAR_VALOR]    Script Date: 06/16/2015 16:55:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  View [dbo].[par_tipo_documento]    Script Date: 06/16/2015 16:55:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[par_tipo]    Script Date: 06/16/2015 16:55:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
WHERE CONTEXTO='TIPO'
GO
/****** Object:  View [dbo].[par_estado_usuario]    Script Date: 06/16/2015 16:55:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[par_estado_permiso]    Script Date: 06/16/2015 16:55:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CLI_MODULO_EMPRESA]    Script Date: 06/16/2015 16:55:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[ADM_PERMISO]    Script Date: 06/16/2015 16:55:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[ADM_USUARIO]    Script Date: 06/16/2015 16:55:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[ADM_USUARIO_ROL]    Script Date: 06/16/2015 16:55:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[ADM_SESSION]    Script Date: 06/16/2015 16:55:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[ADM_PERFIL]    Script Date: 06/16/2015 16:55:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  ForeignKey [FK_5d6dxhdxbq18ra2wp8mqlllh6]    Script Date: 06/16/2015 16:55:16 ******/
...
GO
/****** Object:  ForeignKey [FK_gg4ommcircvel10rao9wy1rlx]    Script Date: 06/16/2015 16:55:16 ******/
...
GO
/****** Object:  ForeignKey [FK_1nofqopxo1c144mbslfmsjt0f]    Script Date: 06/16/2015 16:55:16 ******/
...
GO
/****** Object:  ForeignKey [FK_2amchsbjfieq1p5o2pafujlj2]    Script Date: 06/16/2015 16:55:16 ******/
...
GO
/****** Object:  ForeignKey [FK_ecgasj61sx7uyv1edlsq0oogl]    Script Date: 06/16/2015 16:55:16 ******/
...
GO
/****** Object:  ForeignKey [FK_fmf6s1fx5quoqcfklhcqdtuv4]    Script Date: 06/16/2015 16:55:16 ******/
...
GO
/****** Object:  ForeignKey [FK_fy1mjx2bkiechabw997ii4gc6]    Script Date: 06/16/2015 16:55:16 ******/
...
GO
/****** Object:  ForeignKey [FK_g6wly613b12mn5292rduacps]    Script Date: 06/16/2015 16:55:16 ******/
...
GO
/****** Object:  ForeignKey [FK_s1wa4qt4jp06ew19271tfw42e]    Script Date: 06/16/2015 16:55:16 ******/
